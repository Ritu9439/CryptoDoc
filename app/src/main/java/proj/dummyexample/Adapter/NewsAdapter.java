...
import proj.dummyexample.NewsFullScreen;
...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        Glide.with(context).load("https://letstalkbitcoin.com/resources/files/images/LTBNETWORK-LOGO3.jpg").into(holder.image);
